...
This folder centralizes the engineering playbooks that define how we build and evolve the Pinata IPFS scripts. Treat the guidance here as the source of truth for day-to-day decisions and for long-term architectural planning.
