...
import { HealthCheckResult, HealthStatus, LogLevel, PerformanceMetrics } from '../types';
...
export class MetricsCollector {
  ...
  public recordHealthCheck(result: HealthCheckResult): void {
    ...
    const logLevel = result.status === HealthStatus.HEALTHY ? LogLevel.INFO : LogLevel.WARN;
   ...
   * @param olderThanHours - Age in hours to retain metrics (default: 24 hours)
   */
